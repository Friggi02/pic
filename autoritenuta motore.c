/*Il programma serve a comandare un motore tramite dei pulsanti grazie ad un sistema di autoritenuta.*/
...
// Other definition
#define comando_avanti      RA0 
#define comando_indietro    RA1
#define comando_stop        RA2 
#define avanti              RC0
#define indietro            RC1
...
void main(){
    ...
    while(1){   
        while(comando_stop==0){
            if(comando_avanti==1 || avanti==1){
                avanti=1;
            }
            if(comando_indietro==1 || indietro==1){
                indietro=1;
            }                
        }
        avanti=0;
